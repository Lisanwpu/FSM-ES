...
def check_dataset(data, autodownload=True):
    ...
    for k in 'train', 'val', 'nc':
        assert k in data, emojis(f"lastyolov5.yaml '{k}:' field missing ❌")
    if 'names' not in data:
        LOGGER.warning(emojis("lastyolov5.yaml 'names:' field missing ⚠, assigning default names 'class0', 'class1', etc."))
...
def download(url, dir='.', unzip=True, delete=True, curl=False, threads=1, retry=3):
    # Multi-threaded file download and unzip function, used in lastyolov5.yaml for autodownload
